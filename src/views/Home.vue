<template>
  <div class="home">
    ...
    <van-nav-bar
      :title="currentActivity?.name ?? '迷住团购管家'"
      fixed
      placeholder
    ...
    >
      ...
      <template #right>
        <van-icon
          ...
          name="edit"
          size="18"
          @click="router.push(`/activity-form?edit=1&id=${currentActivity.id}`)"
        />
      </template>
    </van-nav-bar>
      ...
      <div class="activity-popup">
        ...
        <van-cell-group inset>
          ...
          >
            ...
            <template #value>
              <van-tag v-if="act.id === currentActivityId" type="primary" plain size="mini">
                当前
              </van-tag>
            </template>
          </van-cell>
...
const overview = computed(() => {
  ...
  return { totalOrder, itemCount, totalPaid, totalPending, storePending, mizhuPending, progressPercent }
})
